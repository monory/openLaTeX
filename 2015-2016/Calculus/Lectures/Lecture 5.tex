    ...
    \leavevmode
        \begin{enumerate}
            ...
            \item
                ...
                \( \underset{0 \le x \le 2\pi}{\sup} \left| r_n(x) \right| =
                \underset{0 \le x \le 2\pi}{\sup}
                ...
                \(\sum^{\infty}_{1} \frac{1}{k ^ \alpha}\) расх.
         \end{enumerate}

         \newpage

         \begin{center}
             Аналитические свойства равномерно сх-ся посл-ей и рядов.
         \end{center}
         ...
         \begin{enumerate}
             \item
                Непрерывность:\\
                \begin{Definition}
                    \(\varphi(x)\) наз-ся \textbf{непр. в точке} \(x_0\) на множестве D, 
                    если
                ...
                \begin{Thm}
                    Пусть есть \(\scalebox{1.2}{\(\{f_n(x)\}^{\infty}_{n = 1}\)}\). Если \(f_n(x)\) непр. в D \(\ \forall n\) 
                    и \(f_n \xrightarrow{D} f\),\\ то \(f\) непр. в D.
                \end{Thm}

                \begin{proof}
                    \(\forall x_0 \in D \left| f(x) - f(x_0)\right| \le
                    \varepsilon\)\\
                    \(\le \underset{< \frac{\varepsilon}{3}
                    ('cause f_n \xrightarrow{D} f)}{\left| f(x) - f_n(x) \right|}
                    + \left| f_n(x) - f_n(x_0)\right| +
                    \underset{< \frac{\varepsilon}{3}
                    ('cause f_n \xrightarrow{D} f)}{\left| f_n(x_0) - f(x_0)\right|}\)
                \end{proof}
                ...
                \begin{Note}
                    ...
                    f_n(x)\]
                    \(\Rightarrow f\) - непр. на D. 
                \end{Note}

                \begin{Consequence}
                    Если \( u_k(x) \) - непр. в D и \( \sum^{\infty}_{1} u_k(x)\)
                     равн. сх-ся в D, то \(S(x) = \sum^{\infty}_{1} u_k(x)\) 
                     - непр. в D
                \end{Consequence}
             \item
                Интегрируемость:\\
                \begin{Thm}
                    ...
                    \[\underset{= \Phi_n(x)}{\int^{x}_{a} f_n(t)dt}
                    \xrightarrow{[a; b]} \underset{= \Phi(x)}{\int^{x}_{a}f(t)dt}\]
                \end{Thm}

                \begin{proof}
                    Т.к. \(f_n\) - непр в D и \( f_n \xrightarrow{D} f\), 
                    то по пред. теор. \(\Rightarrow f\) - непр. в D 
                    \(\Rightarrow f\) - интегр. на \(D = [a; b]\) \\

                    \( \left| \Phi_n(x) - \Phi(x) \right| \le \int^{x}_{a}
                    \underset{< \varepsilon}{\left| f_n(t) - f(t)\right|}dt
                    \le (b - a) \cdot \varepsilon\)
                \end{proof}

                \begin{Consequence}
                    \(u_k(x)\) - непр. в \(D = [a; b] \ \forall k\) и ряд
                    \(\sum^{\infty}_{1} u_k(x)\) равн. сх-ся на D.\\

                    Тогда
                    \[ \int^{x}_{a} \sum^{\infty}_{1} u_k(t)dt = 
                    \sum^{\infty}_{k = 1} \int^{x}_{a} u_k(t)dt\]
                \end{Consequence}
